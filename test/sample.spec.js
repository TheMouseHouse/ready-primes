...
var JsonHelper = require( '../bin/helpers/JsonHelper' ).JsonHelper;
var testFile = 'test';
var jsonTestFile = testFile + '.json';
var testData = { "value": "passed" };
var primeTestData = [ 2, 3, 5, 7 ];
var integerTestData = [ 0, 0, 1, 1 ];
...
describe( 'JsonHelper', function () {
	...
	describe( 'Read', function () {
		...
		describe( '#readIntegerFile()', function () {
			...
			var lastTestInteger = _.last( integerTestData );
